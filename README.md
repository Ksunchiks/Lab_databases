...
#### Создать  4 различных хранимых процедуры:
	...
	b) Процедура, которая для заданной корзины формирует список лежащих в ней товаров в виде: название, количество, дата производства, вес;
...
#### Создать 3 пользовательских функции:
	...
	c) Multi-statement-функция, выдающая список карт, суммарная стоимость покупок по которым превысила 10 000р., в виде: номер карты, дата выдачи, % скидки, общая сумма покупок по карте.
