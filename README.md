...
1.2. **Выбрать из произвольной таблицы те записи, которые удовлетворяют условию отбора (WHERE)**
   - Привести 2-3 запроса

1.3. **Привести примеры использования агрегатных функций**
   - 2-3 запроса с использованием COUNT, MAX, SUM и др.
   - С группировкой и без группировки

1.4. **Привести примеры подведения итогов с использованием GROUP BY**
   - GROUP BY ALL
   - GROUP BY CUBE | ROLLUP (2-3 запроса)
